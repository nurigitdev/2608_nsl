...
- `include`는 이 Slice에서 예약 Keyword로 고정했다. Slice 0005에서 Include AST와 Root/Fragment Parse Mode가 추가되었고, Slice 0006에서 안전한 Source 해석과 구조적 합성이 완료되었다.
...
- `NSL-SRC-008`, `NSL-SRC-010`은 Slice 0006에서 Include 보안과 결정성 검증을 거쳐 `IMPLEMENTED`로 승격되었다.
